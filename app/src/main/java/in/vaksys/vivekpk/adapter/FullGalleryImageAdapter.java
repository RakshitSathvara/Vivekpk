 ...
 */
public class FullGalleryImageAdapter extends RecyclerView.Adapter<FullGalleryImageAdapter.ViewHolder> {
    ...
    public FullGalleryImageAdapter(Context context, RealmResults<UserImages> userImages) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.license_gallery_full_view, parent, false);
